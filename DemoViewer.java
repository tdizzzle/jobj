...
public class DemoViewer {
    ...
    public static final List<? extends render> exampleCube = Arrays.asList(
    ...
    public static final List<? extends render> exampleSphere = createExampleSphere();

    private static List<? extends render> createExampleSphere() {
    ...
    public static List<render> generateHexagon(double radius, double height, Color[] faceColors) {
        ...
        List<render> hexagon = new ArrayList<>();
    ...
    public static final List<render> exampleHexagon = generateHexagon(
            100, // radius
            100, // height
            new Color[] {
    ...
    public static List<? extends render> currentShape = exampleTriangle;
